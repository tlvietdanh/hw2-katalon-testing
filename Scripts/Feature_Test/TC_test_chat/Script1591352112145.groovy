...
WebUI.sendKeys(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/textarea_Write to Town Square_post_textbox'), Keys.chord('This is test string',Keys.ENTER))
