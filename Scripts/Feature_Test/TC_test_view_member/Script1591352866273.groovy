...
WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_View Members'))

WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_cancle_view_member'))
