...
if(!target_email_temp.toString().equals('') && WebUI.verifyElementPresent(findTestObject('Object Repository/Page_User_Permission/span_Email'), 2, FailureHandling.OPTIONAL)) {
	...
	if(WebUI.verifyEqual(button.contains('System Admin'), true, FailureHandling.OPTIONAL)) {
		WebUI.click(findTestObject('Object Repository/Page_User_Permission/span_Member'))
		
		WebUI.click(findTestObject('Object Repository/Page_User_Permission/span_Manage_Roles_admin'))
		
		
		WebUI.click(findTestObject('Object Repository/Page_User_Permission/radio_button_systemmember'))
