...
if(WebUI.verifyElementPresent(findTestObject('Object Repository/Rename_channel/span_Town Square'), 1, FailureHandling.OPTIONAL)) {
	...
	WebUI.setText(findTestObject('Object Repository/Rename_channel/input_Display Name_display_name'), newName)
	
	WebUI.click(findTestObject('Object Repository/Rename_channel/button_Save'));
	
	WebUI.waitForElementVisible(findTestObject('Object Repository/Rename_channel/span_Display name must have at least 2 characters'), 1)
	
	def error = WebUI.getText(findTestObject('Object Repository/Rename_channel/span_Display name must have at least 2 characters'))
	
	WebUI.verifyEqual(error.contains('Display name must have at least 2 characters'), true)
}
