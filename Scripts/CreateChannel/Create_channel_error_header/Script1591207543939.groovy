...
WebUI.callTestCase(findTestCase('Test Cases/Login/Test login'), [('var_user') : 'tlvietdanh@gmail.com', ('var_password') : '13101998'], 
...
if(is_private && is_private.toString().equals("0")) {
