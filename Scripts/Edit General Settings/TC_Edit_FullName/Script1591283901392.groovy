...
WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_Edit_FullName'))

WebUI.setText(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/input_First Name_firstName'), var_firstname)

WebUI.setText(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/input_Last Name_lastName'), var_lastname)

WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_Save_FullName'))
