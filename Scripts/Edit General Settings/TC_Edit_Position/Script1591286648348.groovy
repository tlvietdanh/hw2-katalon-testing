...
WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_Edit_Position'))

WebUI.setText(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/input_Position_position'), var_position)


WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_Save_Position'))
