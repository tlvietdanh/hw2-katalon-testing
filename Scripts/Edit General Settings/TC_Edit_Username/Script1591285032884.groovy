...
WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/span_Edit_Username'))

WebUI.setText(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/input_Username_username'), var_username)


WebUI.click(findTestObject('Object Repository/Page_Town Square-Mattermost_Homepage/button_Save_Username'))
